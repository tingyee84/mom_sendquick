...
$.post("<?php echo $header_lib?>",{mode:"getmenu"<?php echo !empty($page_mode)? ",page:$page_mode" : "";?>},function(e){$("#web_menu").html(e),-1!==jQuery.inArray(document.location.pathname.match(/[^\/]+$/)[0],["keyword_add.php","keyword_edit.php"])&&$(".key_sub_menu").addClass("active")}).done(function(ev){
