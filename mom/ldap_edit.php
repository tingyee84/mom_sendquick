<?php
	$page_mode = '45';
	$page_title = 'Edit LDAP Server';
	include('header.php');
	include('checkAccess.php');
	$x = GetLanguage("ldap_edit",$lang);
...
?>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<form name="edit_ldap" id="edit_ldap">
							<div class="row">
								<div class="col-lg-3">
									<label class="control-label"><b><?php echo $x->name;?></b> <span style="color:red">*</span></label>
								</div>
								<div class="col-lg-4 entera">
									<input class="form-control input-sm" type="text" name="l_name" id="l_name" maxlength="100" required/>
								</div>
							...
							<div class="row">
								...
								<div class="col-lg-4 entera">
									<textarea class="form-control input-sm" name="l_desc" id="l_desc"></textarea>
								</div>
							</div>
							<hr>
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-lg-4">
									<select name="l_loginmode" id="l_loginmode">
							...
							<div class="row">
								...
								<div class="col-lg-4 entera">
									<input class="form-control input-sm" type="text" name="l_mobile" id="l_mobile" placeholder="mobile">
								</div>
								<div class="col-lg-5 help-block">
							...
							<div class="row">
								...
								<div class="col-lg-4 entera">
									<input class="form-control input-sm" type="text" name="l_mail" id = "l_mail" placeholder="mail">
								</div>
								<div class="col-lg-5 help-block">
							...
							<div class="row">
								...
								<div class="col-lg-4 entera">
									<input class="form-control input-sm" type="text" name="l_basedn" id="l_basedn" placeholder="dc=testserver,dc=com"/>
								</div>
								<div class="col-lg-5 help-block">
							...
							<div class="row">
								...
								<div class="col-lg-4">
									<select name="l_scope" id="l_scope">
							...
							<div class="row">
								...
								<div class="col-lg-9">
									...
									<tr>
										...
										<td class="text-left">
											<select name="sync_time" id="sync_time">
										...
										<td class="text-left">
											...
											<div id="div_ul" class="hidden">
												...
												<tr>
													...
													<td class="text-left">
														<select name="user_dept" id="user_dept" class="department">
											...
											<div id="div_gab" class="hidden">
												...
												<tr>
													...
													<td><select name="gab_dept" id="gab_dept" class="department">
														<option value="0"><?php echo $x->no_department;?></option>
														</select>
													</td>
												</tr>
							...
							<div class="row text-center">
								<input type="hidden" name="ldapid" value="<?php echo $_GET['ldapid'];?>">
								<input type="hidden" name="mode" value="editLDAPServer">
		...
		<div id="loginmode" class="popover">
			<div class="popover-content"><small>
				<table class="table table-bordered table-condensed">
					...
					<tr><td>Login ID</td><td>sAMAccountName</td><td>mail</td></tr>
					<tr><td>Email</td><td>uid</td><td>mail</td></tr>
					<tr><td>Display Name</td><td>displayName</td><td>displayName</td></tr>
				</table></small>
			</div>
		</div>
	...
	var target_lid = '<?php echo $_GET['ldapid'];?>';
	...
	<script src="ldap_edit_js.php"></script>
