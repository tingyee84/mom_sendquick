<?php
	$page_mode = '7';
	$page_title = 'MIM Message Template';
	include('header.php');
		...
		<div class="page-header page-header2">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page"><?php echo $xml->mim_msg_tmpl;?></li>
				</ol>
			</nav>
		</div>
								...
								<tr>
									<td colspan="4">
										<span class="pull-left">
											...
											<!--<button type="submit" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myUpload"><?php echo $xml_common->upload;?></button>&emsp;-->
										</span>
										<div id="export"></div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-md-8 offset-md-2">
								<input type = "text" class="form-control input-sm" name = "mim_tpl_id" id = "mim_tpl_id" maxlength="100" value = "" required>
